...
public:
	CRecordSound(int iHertz=16000);           // protected constructor used by dynamic creation
...
protected:
	...
	//}}AFX_MSG
	afx_msg WM_ON_MSG OnStartRecording(WPARAM wParam, LPARAM lParam);
	afx_msg WM_ON_MSG OnStopRecording(WPARAM wParam, LPARAM lParam);
	afx_msg WM_ON_MSG OnSoundData(WPARAM wParam, LPARAM lParam);
	afx_msg WM_ON_MSG OnPtrSoundPlayer(WPARAM wParam, LPARAM lParam);
	afx_msg WM_ON_MSG OnPtrSoundWriter(WPARAM wParam, LPARAM lParam);
