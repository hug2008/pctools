...
void CPropPageEncrypt::OnSaveData(void)
{
	...
	UpdateData(TRUE);
	 ...
	 if (m_nEncryptSolution == 0)
		m_pParentWnd->m_strStartNet_0019_sEncryptSolution.Format("%d", 12);
	 //m_nEncryptSolution = 13;
	 if (m_nEncryptSolution == 1)
		m_pParentWnd->m_strStartNet_0019_sEncryptSolution.Format("%d", 13);

#ifdef CARD_ENCRYPT	
	m_pParentWnd->m_strStartNet_0017_sVenderNO= m_sVendor;
	m_pParentWnd->m_strStartNet_0031_sKeyNO= m_skeyno;

	m_pParentWnd->m_strStartNet_0020_sKeyword1 = m_skeyword1;
	m_pParentWnd->m_strStartNet_0021_sKeyword2 = m_skeyword2;
	m_pParentWnd->m_strStartNet_0022_sKeyword3 = m_skeyword3;
	m_pParentWnd->m_strStartNet_0023_sKeyword4 = m_skeyword4;
	m_pParentWnd->m_strStartNet_0024_sKeyword5 = m_skeyword5;
#endif
...
//	CString strTemp;
	...
	temp = atoi(m_pParentWnd->m_strStartNet_0019_sEncryptSolution);
	...
	if (temp == 13)
	{
		...
		m_sVendor  = m_pParentWnd->m_strStartNet_0017_sVenderNO;
		// 4 -- the edit  --key NO.
		m_skeyno  = m_pParentWnd->m_strStartNet_0031_sKeyNO;
		
		// 5 -- the edits -- keywords of the Encrypted info.
		m_skeyword1 = m_pParentWnd->m_strStartNet_0020_sKeyword1;
		m_skeyword2 = m_pParentWnd->m_strStartNet_0021_sKeyword2;
		m_skeyword3 = m_pParentWnd->m_strStartNet_0022_sKeyword3;
		m_skeyword4 = m_pParentWnd->m_strStartNet_0023_sKeyword4;
		m_skeyword5 = m_pParentWnd->m_strStartNet_0024_sKeyword5;
	#endif

	}
	
		//	m_nEncryptSolution = atoi(m_pParentWnd->m_strStartNet_0019_sEncryptSolution);
