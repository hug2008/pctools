...
public:
	...
	//             uPictureID  - Resource ID of the bitmap to display.
	
	//             pParentWnd - Parent window of the splash screen, can be NULL.
	
	//             bBmpORJpg - Resource ID is of BMP file or JPG file, TRUE for BMP
	...
	static BOOL ShowSplashScreen(UINT uTimeOut, UINT uPictureID, CWnd* pParentWnd = NULL, BOOL bBmpORJpg = TRUE);
	
	static BOOL ShowSplashScreen(UINT uTimeOut, CString strPic, CWnd* pParentWnd = NULL, BOOL bBmpORJpg = TRUE);
