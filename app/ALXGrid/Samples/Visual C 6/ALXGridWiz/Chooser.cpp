...
CDialogChooser::CDialogChooser()
{
	...
	m_pDlgs[8] = new CGridHeadDlg;
	m_pDlgs[9] = new CClassesDlg;
...
static int nDocTrack[] = {0, 1, 2, 3, 4, 5, 8, 9};
static int nDlgTrack[] = {0, 1, 7, 5, 8, 9};
...
CAppWizStepDlg* CDialogChooser::Next(CAppWizStepDlg* pDlg)
{
	...
	{
		CString strTemp;
		m_nTrack = ALXAppWz.m_Dictionary.Lookup(_T("PROJTYPE_DLG"), strTemp) ? 1 : 0;
