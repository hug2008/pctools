========================================================================
                    CUSTOM APPWIZARD: ALXGridWiz
========================================================================


AppWizard has created a ALXGridWiz DLL for you.  This DLL is the starting point
...
you build ALXGridWiz.awx, it will automatically be copied to your Template
...
ALXGridWizAw.h, ALXGridWizAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CALXGridWizAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into ALXGridWiz.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named ALXGridWiz.pch and a precompiled types file named StdAfx.obj.
