...
$$IF(SPLITTER_SDI || PROJTYPE_EXPLORER)
protected:
$$IF(CXGridView || CXGridCtrl)
$$IF(PROJTYPE_EXPLORER)
$$IF(SPLITTER_SDI)
	CSplitterWnd m_wndSSplitter;	// static splitter
	CALXSplitterWnd m_wndSplitter;	// dinamic splitter
$$ELSE // Not SPLITTER_SDI
	CSplitterWnd m_wndSplitter;	// static splitter
$$ENDIF // SPLITTER_SDI
$$ELSE  // Not PROJTYPE_EXPLORER 
	CSplitterWnd m_wndSplitter;	// static splitter
$$ENDIF // PROJTYPE_EXPLORER
$$ELSE //!(CXGridView || CXGridCtrl)
	CSplitterWnd m_wndSplitter;
$$ENDIF //CXGridView || CXGridCtrl
$$ENDIF //SPLITTER_SDI || EXPLORER
